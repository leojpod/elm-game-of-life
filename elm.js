...
var _user$project$Board_Types$Alive = {ctor: 'Alive'};
var _user$project$Board_Types$Dead = {ctor: 'Dead'};
var _user$project$Board_Types$Empty = {ctor: 'Empty'};
var _user$project$Board_Types$Tick = {ctor: 'Tick'};
var _user$project$Board_Types$Update = function (a) {
	return {ctor: 'Update', _0: a};
};

var _user$project$Board_State$neighbourCount = F3(
	function (x, y, arrayBoard) {
		var currentRow = A2(_elm_lang$core$Array$get, x, arrayBoard);
		var belowRow = A2(_elm_lang$core$Array$get, x + 1, arrayBoard);
		var aboveRow = A2(_elm_lang$core$Array$get, x - 1, arrayBoard);
			...
			A2(
				...
				function (just) {
					...
					if (_p0.ctor === 'Just') {
						var _p1 = _p0._0;
						if (_p1.ctor === 'Alive') {
							return _elm_lang$core$Maybe$Just(_user$project$Board_Types$Alive);
						} else {
							return _elm_lang$core$Maybe$Nothing;
						}
					} else {
...
var _user$project$Board_State$compute = function (board) {
	var arrayBoard = _elm_lang$core$Array$fromList(
		A2(_elm_lang$core$List$map, _elm_lang$core$Array$fromList, board));
	return function (newArray) {
		return _elm_lang$core$Array$toList(
			A2(_elm_lang$core$Array$map, _elm_lang$core$Array$toList, newArray));
	}(
		A2(
			...
			F2(
				function (x, row) {
					return A2(
						...
						F2(
							function (y, cell) {
								var neighbours = A3(_user$project$Board_State$neighbourCount, x, y, arrayBoard);
								var _p2 = cell;
								if (_p2.ctor === 'Alive') {
									return (_elm_lang$core$Native_Utils.eq(neighbours, 3) || _elm_lang$core$Native_Utils.eq(neighbours, 2)) ? _user$project$Board_Types$Alive : _user$project$Board_Types$Dead;
								} else {
									return _elm_lang$core$Native_Utils.eq(neighbours, 3) ? _user$project$Board_Types$Alive : _user$project$Board_Types$Empty;
								}
							}),
						row);
				}),
...
var _user$project$Board_State$update = F2(
	function (msg, board) {
		var _p3 = msg;
		if (_p3.ctor === 'Update') {
			...
			return {
				ctor: '_Tuple2',
				_0: _user$project$Board_State$compute(board),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		}
	});
var _user$project$Board_State$randCell = A2(
	_elm_lang$core$Random$map,
	function (b) {
		return b ? _user$project$Board_Types$Alive : _user$project$Board_Types$Empty;
	},
	_elm_lang$core$Random$bool);
var _user$project$Board_State$initialRandomGeneration = F2(
	function (xSize, ySize) {
		return A2(
			_elm_lang$core$Random$generate,
			_user$project$Board_Types$Update,
			A2(
				_elm_lang$core$Random$list,
				xSize,
				A2(_elm_lang$core$Random$list, ySize, _user$project$Board_State$randCell)));
	});
var _user$project$Board_State$init = {
	ctor: '_Tuple2',
	_0: A2(
		_elm_lang$core$List$repeat,
		10,
		A2(_elm_lang$core$List$repeat, 10, _user$project$Board_Types$Empty)),
	_1: A2(_user$project$Board_State$initialRandomGeneration, 10, 10)
};

var _user$project$Board_View$cellView = F3(
			...
			_0: A2(
				_elm_lang$svg$Svg$rect,
				{
					...
					_0: _elm_lang$svg$Svg_Attributes$x(
						_elm_lang$core$Basics$toString(colIdx * 10)),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$y(
							_elm_lang$core$Basics$toString(rowIdx * 10)),
						_1: {
							ctor: '::',
							...
							_0: A2(
								_elm_lang$svg$Svg$circle,
								{
									...
									_0: _elm_lang$svg$Svg_Attributes$cx(
										_elm_lang$core$Basics$toString((colIdx * 10) + 5)),
									_1: {
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$cy(
											_elm_lang$core$Basics$toString((rowIdx * 10) + 5)),
										_1: {
											ctor: '::',
											_0: _elm_lang$svg$Svg_Attributes$r('5'),
											_1: {
												ctor: '::',
												_0: _elm_lang$svg$Svg_Attributes$fill('rgb(0, 121, 107)'),
												_1: {ctor: '[]'}
											}
										}
									}
								...
								_elm_lang$svg$Svg$circle,
								{
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$svg$Svg_Attributes$fill('rgb(0, 150, 136)'),
												_1: {ctor: '[]'}
											}
										}
									}
...
var _user$project$Board_View$rowView = F2(
	function (idx, row) {
		return _elm_lang$core$List$concat(
			A2(
				_elm_lang$core$List$indexedMap,
				_user$project$Board_View$cellView(idx),
				row));
	});
var _user$project$Board_View$boardDisplay = function (board) {
	return A2(
		...
		},
		{
			...
			_1: _elm_lang$core$List$concat(
				A2(_elm_lang$core$List$indexedMap, _user$project$Board_View$rowView, board))
		});
};
var _user$project$Board_View$boardView = F2(
	function (board, mdlModel) {
		return A2(
			_debois$elm_mdl$Material_Card$view,
			{
				ctor: '::',
				_0: _debois$elm_mdl$Material_Elevation$e24,
				_1: {
					ctor: '::',
					_0: _debois$elm_mdl$Material_Elevation$transition(1000),
					_1: {
						ctor: '::',
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$Board_View$boardDisplay(board),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			});
...
var _user$project$Setup_Types$speedToInterval = function (speed) {
	var _p0 = speed;
	switch (_p0.ctor) {
		case 'Slow':
			return 3 * _elm_lang$core$Time$second;
		case 'Normal':
			return 1 * _elm_lang$core$Time$second;
		case 'Fast':
			return 500 * _elm_lang$core$Time$millisecond;
		default:
			return 250 * _elm_lang$core$Time$millisecond;
	}
};
var _user$project$Setup_Types$speedToInt = function (speed) {
	var _p1 = speed;
	switch (_p1.ctor) {
		case 'Slow':
			return 0;
...
var _user$project$Setup_Types$Setup = F3(
	function (a, b, c) {
		return {state: a, speed: b, size: c};
	});
var _user$project$Setup_Types$Pause = {ctor: 'Pause'};
var _user$project$Setup_Types$Play = {ctor: 'Play'};
var _user$project$Setup_Types$SuperFast = {ctor: 'SuperFast'};
var _user$project$Setup_Types$Fast = {ctor: 'Fast'};
var _user$project$Setup_Types$Normal = {ctor: 'Normal'};
var _user$project$Setup_Types$Slow = {ctor: 'Slow'};
var _user$project$Setup_Types$intToSpeed = function (speed) {
	return _elm_lang$core$Native_Utils.eq(speed, 0) ? _user$project$Setup_Types$Slow : (_elm_lang$core$Native_Utils.eq(speed, 1) ? _user$project$Setup_Types$Normal : (_elm_lang$core$Native_Utils.eq(speed, 2) ? _user$project$Setup_Types$Fast : (_elm_lang$core$Native_Utils.eq(speed, 3) ? _user$project$Setup_Types$SuperFast : _user$project$Setup_Types$Normal)));
};
var _user$project$Setup_Types$NoOps = {ctor: 'NoOps'};
var _user$project$Setup_Types$SizeChange = function (a) {
	return {ctor: 'SizeChange', _0: a};
};
var _user$project$Setup_Types$SpeedChange = function (a) {
	return {ctor: 'SpeedChange', _0: a};
};
var _user$project$Setup_Types$StateChange = function (a) {
	return {ctor: 'StateChange', _0: a};
};

var _user$project$Types$Model = F3(
	function (a, b, c) {
		return {board: a, setup: b, mdl: c};
	});
var _user$project$Types$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _user$project$Types$SetupMsg = function (a) {
	return {ctor: 'SetupMsg', _0: a};
};
var _user$project$Types$BoardMsg = function (a) {
	return {ctor: 'BoardMsg', _0: a};
};

var _user$project$Setup_State$update = F2(
	function (msg, setup) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'StateChange':
			...
			default:
				return {ctor: '_Tuple2', _0: setup, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
var _user$project$Setup_State$init = A3(_user$project$Setup_Types$Setup, _user$project$Setup_Types$Pause, _user$project$Setup_Types$Normal, 10);

var _user$project$State$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(_debois$elm_mdl$Material$subscriptions, _user$project$Types$Mdl, model),
			_1: {
				ctor: '::',
				_0: function () {
					var _p0 = model.setup.state;
					if (_p0.ctor === 'Play') {
						return A2(
							_elm_lang$core$Time$every,
							_user$project$Setup_Types$speedToInterval(model.setup.speed),
							function (_p1) {
								return _user$project$Types$BoardMsg(_user$project$Board_Types$Tick);
							});
					} else {
						return _elm_lang$core$Platform_Sub$none;
					}
		...
		switch (_p2.ctor) {
			case 'BoardMsg':
				return function (_p3) {
					...
					A2(_user$project$Board_State$update, _p2._0, model.board));
			case 'SetupMsg':
				return function (_p5) {
					var _p6 = _p5;
					return {
					...
					A2(_user$project$Setup_State$update, _p2._0, model.setup));
			default:
				return A3(_debois$elm_mdl$Material$update, _user$project$Types$Mdl, _p2._0, model);
		}
	});
var _user$project$State$model = function () {
	var _p7 = _user$project$Board_State$init;
	var startBoard = _p7._0;
	return A3(_user$project$Types$Model, startBoard, _user$project$Setup_State$init, _debois$elm_mdl$Material$model);
}();
var _user$project$State$init = function () {
	var _p8 = _user$project$Board_State$init;
	var initialRandomCmd = _p8._1;
	return {
		ctor: '_Tuple2',
		_0: _user$project$State$model,
		_1: _elm_lang$core$Platform_Cmd$batch(
			{
				ctor: '::',
				_0: A2(
					_elm_lang$core$Platform_Cmd$map,
					function (a) {
						return _user$project$Types$BoardMsg(a);
					},
					initialRandomCmd),
				_1: {
					ctor: '::',
					_0: _debois$elm_mdl$Material_Layout$sub0(_user$project$Types$Mdl),
					_1: {ctor: '[]'}
				}
			})
	};
...
var _user$project$Setup_View$speedChangeView = function (currentSpeed) {
	return _debois$elm_mdl$Material_Slider$view(
		{
			ctor: '::',
			_0: _debois$elm_mdl$Material_Slider$onChange(
				function ($float) {
					var speed = _user$project$Setup_Types$intToSpeed($float);
					return _user$project$Types$SetupMsg(
						_user$project$Setup_Types$SpeedChange(speed));
				}),
			_1: {
				ctor: '::',
				_0: _debois$elm_mdl$Material_Slider$value(
					_user$project$Setup_Types$speedToInt(currentSpeed)),
				_1: {
					ctor: '::',
					_0: _debois$elm_mdl$Material_Slider$min(0),
					_1: {
						ctor: '::',
						_0: _debois$elm_mdl$Material_Slider$max(3),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Setup_View$startStop = F2(
	function (playState, mdlModel) {
		return A5(
							...
							_1: {
								...
								_0: _debois$elm_mdl$Material_Options$onClick(
									function () {
										...
										if (_p0.ctor === 'Play') {
											return _user$project$Types$SetupMsg(
												_user$project$Setup_Types$StateChange(_user$project$Setup_Types$Pause));
										} else {
											return _user$project$Types$SetupMsg(
												_user$project$Setup_Types$StateChange(_user$project$Setup_Types$Play));
										}
									}()),
								_1: {ctor: '[]'}
							}
			...
			},
			{
				...
				_0: function () {
					var _p1 = playState;
					if (_p1.ctor === 'Play') {
						return _debois$elm_mdl$Material_Icon$i('pause');
					} else {
						return _debois$elm_mdl$Material_Icon$i('play_arrow');
					}
				}(),
				_1: {ctor: '[]'}
			});
	});
var _user$project$Setup_View$setupView = F2(
	function (setup, mdlModel) {
		return A2(
			_debois$elm_mdl$Material_Card$view,
			{
				ctor: '::',
				...
				_1: {
					ctor: '::',
					_0: _debois$elm_mdl$Material_Elevation$transition(500),
					_1: {
						ctor: '::',
						_0: A2(_debois$elm_mdl$Material_Grid$size, _debois$elm_mdl$Material_Grid$All, 12),
						_1: {ctor: '[]'}
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Setup'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('setup your game and it will reset accordingly'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
						...
						{ctor: '[]'},
						{
							...
							_0: _elm_lang$html$Html$text(
								A2(
									_elm_lang$core$Basics_ops['++'],
									'select the speed: ',
									_elm_lang$core$Basics$toString(setup.speed))),
							_1: {
								ctor: '::',
								_0: _user$project$Setup_View$speedChangeView(setup.speed),
								_1: {ctor: '[]'}
							}
						}),
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: A2(_user$project$Setup_View$startStop, setup.state, mdlModel),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: A2(_user$project$Setup_View$setupView, model.setup, model.mdl),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							A2(_user$project$Board_View$boardView, model.board, model.mdl)),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
